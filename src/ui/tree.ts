...
function renderPlainDetails(
  ...
  return `
    <details style="margin:6px 0;color:${colors.text};">
      ...
      <pre style="margin:6px 0 0;padding:8px;max-height:300px;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word;background:#000;color:#e5e6eb;border:1px solid ${colors.border};border-radius:6px;font-size:0.75rem;line-height:1.2;">${escapeHtml(text)}</pre>
    </details>
  `;
}
