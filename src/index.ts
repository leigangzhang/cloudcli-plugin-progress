...
export function mount(container: HTMLElement, api: PluginAPI): void {
  ...
  tooltip.style.cssText =
    'position:fixed;z-index:9999;pointer-events:none;opacity:0;max-width:320px;padding:7px 9px;background:#fff;color:#1f2329;border:1px solid #e5e6eb;border-radius:6px;box-shadow:0 4px 14px rgba(0,0,0,0.14);font-family:Georgia, "Times New Roman", serif;font-size:0.72rem;line-height:1.35;white-space:normal;transition:opacity 0.08s;';
