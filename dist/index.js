...
function ensureAssets() {
  ...
  style.textContent = `
    ...
    .pp-turn-panel .pp-markdown { font-family: 'Courier New', 'PingFang SC', 'Microsoft YaHei', serif; }

    .pp-markdown { font-family:'Courier New', 'PingFang SC', 'Microsoft YaHei', serif; font-size:0.75rem; line-height:1.2; color:var(--pp-text); }
